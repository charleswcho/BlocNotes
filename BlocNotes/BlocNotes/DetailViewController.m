...
- (void)viewDidLoad {
    ...
    // Added extra safeguard to catch fetch errors before loading view
...
// Added the ability to dismiss keyboard if touching outside textView
...
// Added core data 
#pragma mark Core data : save note data
...
- (void)insertNewObject:(id)sender {
    ...
    [newManagedObject setValue:event.title forKey:@"title"];
    // Save the context.
    NSError *error = nil;
